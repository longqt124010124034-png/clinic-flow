...
CREATE POLICY "gen_report insert" ON public.generated_reports FOR INSERT TO authenticated
...
CREATE POLICY "export_log insert" ON public.export_logs FOR INSERT TO authenticated
