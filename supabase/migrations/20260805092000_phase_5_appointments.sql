...
CREATE TABLE public.services (
  ...
  code text,
  description text,
  category text, -- examination, treatment, surgery, cosmetic, etc.
...
CREATE TABLE public.appointments (
  ...
  confirmation_status text NOT NULL DEFAULT 'unconfirmed', -- unconfirmed, confirmed, rejected
...
CREATE TABLE public.appointment_reminders (
  ...
  reminder_type text NOT NULL, -- sms, email, call, whatsapp
  send_hours_before integer NOT NULL, -- 24, 3, 1, etc.
