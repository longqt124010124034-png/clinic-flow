  ...
  return (
    <div>
      <PageHeader
        ...
        description="Tạo, quản lý và tải xuống báo cáo lịch hẹn theo ngày, tuần hoặc tháng."
      />
      ...
      {stats.isLoading ? (
        ...
        <section className="mb-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <StatCard icon={<FileText className="size-5" />} label="Tổng báo cáo" value={stats.data.total} />
          <StatCard
      ...
      {reports.isLoading ? (
        ...
        <EmptyState
          ...
          description="Tạo báo cáo mới để xem chi tiết lịch hẹn."
        />
      ) : (
